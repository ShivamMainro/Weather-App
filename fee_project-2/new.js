...
const feels_likeOutput = document.querySelector('.feels_like');
const visibilityOutput = document.querySelector('.visibility');
const air_pressureOutput = document.querySelector('.air_pressure');
const form = document.getElementById('locationInput');
const search = document.querySelector('.search');
const btn = document.querySelector('.submit');
const cities = document.querySelectorAll('.city');

let cityInput = "Rajpura";
...
function fetchWeatherData() {
    fetch(`http://api.weatherapi.com/v1/current.json?key=cd13a49bf2af4f168cc14108242204&q=${cityInput}`)
        ...
        .then(data => {
            ...
            feels_likeOutput.innerHTML = data.current.feelslike_c  + " *C";
            visibilityOutput.innerHTML = data.current.vis_km +"km";
            air_pressureOutput.innerHTML = data.current.pressure_mb + " hPa";
            let timeOfDay = "day";
            ...
            if (code == 1000) {
                ...
                icon.src = `./icons/${timeOfDay}/116.png`;
                ...
                icon.src = `./icons/${timeOfDay}/263.png`;
                ...
                icon.src = `./icons/${timeOfDay}/332.png`;
